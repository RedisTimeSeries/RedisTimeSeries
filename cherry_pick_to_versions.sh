...
show_usage() {
    ...
    echo "  cherry-pick-1.12 (or fix-issue-1.12)"
    echo "  cherry-pick-1.10 (or fix-issue-1.10)"
    echo "  cherry-pick-1.8 (or fix-issue-1.8)"
}
...
main() {
    ...
    local version_branches=("8.4" "8.2" "8.0" "1.12" "1.10" "1.8")
