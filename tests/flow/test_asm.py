...
# Skip entire ASM test file on macOS due to Redis symbol export limitations
# Redis on macOS doesn't export module API symbols by default, causing
# ASM-related RedisModule_Cluster* functions to be unavailable at runtime
