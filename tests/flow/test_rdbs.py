...
def testRDBCompatibility():
    ...
    for fileName in RDBS:
        ...
        if(fileName == "1.4.9_with_avg_ctx.rdb"):
            ...
            assert _get_ts_info(r, 'ts1') == TSInfo([b'totalSamples', 2, b'firstTimestamp', 100, b'lastTimestamp', 120, b'retentionTime', 0, b'chunkCount', 1, b'chunkSize', 4096, b'chunkType', b'compressed', b'duplicatePolicy', None, b'labels', [], b'rules', [[b'ts2', 1000, b'AVG', 0]], b'ignoreMaxTimeDiff', 0, b'ignoreMaxValDiff', b'0'])
            assert _get_ts_info(r, 'ts2') == TSInfo([b'totalSamples', 0, b'firstTimestamp', 0, b'lastTimestamp', 0, b'retentionTime', 0, b'chunkCount', 1, b'chunkSize', 4096, b'chunkType', b'compressed', b'duplicatePolicy', None, b'labels', [], b'rules', [],  b'ignoreMaxTimeDiff', 0, b'ignoreMaxValDiff', b'0'])
