    ...
    { .name = "ENCODING",
      ...
      .subargs =
          (RedisModuleCommandArg[]){
              ...
              { .name = "enc", .type = REDISMODULE_ARG_TYPE_ONEOF, .subargs = (RedisModuleCommandArg *)ENCODING_OPTIONS },
              { 0 } } },
    { .name = "CHUNK_SIZE",
      .type = REDISMODULE_ARG_TYPE_BLOCK,
      .flags = REDISMODULE_CMD_ARG_OPTIONAL,
    ...
    { .name = "DUPLICATE_POLICY",
      ...
      .subargs =
          (RedisModuleCommandArg[]){
              ...
              { .name = "policy", .type = REDISMODULE_ARG_TYPE_ONEOF, .subargs = (RedisModuleCommandArg *)POLICY_OPTIONS },
              { 0 } } },
    { .name = "ON_DUPLICATE",
      .type = REDISMODULE_ARG_TYPE_BLOCK,
      .flags = REDISMODULE_CMD_ARG_OPTIONAL,
      .subargs =
          (RedisModuleCommandArg[]){
              { .name = "ON_DUPLICATE",
                .type = REDISMODULE_ARG_TYPE_PURE_TOKEN,
                .token = "ON_DUPLICATE" },
              { .name = "policy_ovr", .type = REDISMODULE_ARG_TYPE_ONEOF, .subargs = (RedisModuleCommandArg *)POLICY_OPTIONS },
              { 0 } } },
    { .name = "IGNORE",
      .type = REDISMODULE_ARG_TYPE_BLOCK,
      .flags = REDISMODULE_CMD_ARG_OPTIONAL,
    ...
    { .name = "retention_block",
      ...
      .subargs =
          (RedisModuleCommandArg[]){ { .name = "retention_token",
                                       .type = REDISMODULE_ARG_TYPE_PURE_TOKEN,
                                       .token = "RETENTION" },
                                     { .name = "retentionPeriod", .type = REDISMODULE_ARG_TYPE_INTEGER },
                                     { 0 } } },
    { .name = "encoding_block",
      .type = REDISMODULE_ARG_TYPE_BLOCK,
      .flags = REDISMODULE_CMD_ARG_OPTIONAL,
              ...
              { .name = "buckettimestamp_block",
                ...
                .subargs =
                    (RedisModuleCommandArg[]){
                        ...
                        { .name = "bt",
                          .type = REDISMODULE_ARG_TYPE_ONEOF,
                          .subargs = (RedisModuleCommandArg *)BUCKETTIMESTAMP_OPTIONS },
                        { 0 } } },
              { .name = "empty_token",
                .type = REDISMODULE_ARG_TYPE_PURE_TOKEN,
                .flags = REDISMODULE_CMD_ARG_OPTIONAL,
