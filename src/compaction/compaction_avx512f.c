...
void MaxAppendValuesAVX512F(void *__restrict__ context, double *__restrict__ values, size_t si, size_t ei) {
    double *res = &((MaxMinContext *)context)->maxValue;
    double vec[VECTOR_SIZE] __attribute__ ((aligned (8))) = {_DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG,
    _DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG, _DOUBLE_MOST_NEG};
